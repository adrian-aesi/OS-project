...
from gui.storage_screen import StorageScreen
from gui.virtual_memory_screen import VirtualMemoryScreen
from gui.deadlock_screen import DeadlockScreen
...
class HomeScreen:
    ...
    def show_welcome(self):
        ...
        modules = [
            ...
            ("💾  Virtual Memory",  "FIFO · LRU · OPT · Second Chance · LFU · MFU",  "💾  Virtual Memory"),
            ("📀  Mass Storage",    "FCFS · SSTF · SCAN · C-SCAN · LOOK · C-LOOK",    "📀  Mass Storage"),
            ("🔒  Deadlock",        "Banker's Algorithm · RAG · Wait-For Graph",      "🔒  Deadlock"),
        ]
    ...
    def show_memory(self):
        self.clear_content()
        MemoryScreen(self.content)

    def show_virtual(self):
        self.clear_content()
        VirtualMemoryScreen(self.content)

    def show_storage(self):
        self.clear_content()
        StorageScreen(self.content)
